...
- `docs/R2_PRODUCTION_CHECKLIST.md`: checklist de despliegue de imagenes en Cloudflare R2 para staging/prod.
- `docs/RELEASE_RUNBOOK.md`: proceso oficial de versionado y release automatizado (client + server).
